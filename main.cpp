...
#if defined(NDEBUG)
# error "ADACcoin cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAge = 1000 * 60 * 60; // 8 hours
unsigned int nModifierInterval = 1000 * 60; // time to elapse before new modifier is computed
...
const string strMessageMagic = "ADACcoin Signed Message:\n";
